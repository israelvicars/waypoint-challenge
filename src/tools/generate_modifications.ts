...
function buildUserMessage(lessonMarkdown: string, studentProfiles: Array<{ name: string; profile: string }>, isMulti: boolean): string {
...
function warnIfUngrounded(guide: string): void {
...
export async function generateModifications(lessonId: string, studentIds: string[]): Promise<string> {
